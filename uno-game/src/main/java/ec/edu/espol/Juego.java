...
public class Juego {
    ...
    private ArrayList<Carta> lineaDeJuego = new ArrayList<>();
    private boolean turno;

    public Juego(){
        //  CREACION DE LA BARAJA (Bloque de codigo candidato a ponerlo en Utilitaria)
        for(int a = 0; a<10; a++){
        ...
        lineaDeJuego.add(baraja.remove(0)); //Aqui podria ir un indice random.
    }
